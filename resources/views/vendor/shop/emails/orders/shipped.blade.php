@component('shop::emails.layout')
    <div style="margin-bottom: 34px;">
        ...
        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;margin-top: 20px;">
            NAIL EDIT kasvab koos oma klientidega.<br>
            Kui oled jõudnud tooteid proovida, oleme väga tänulikud, kui jagad oma kogemust ka meie e-poes.<br>
            Sinu tagasiside on see mis loob usalduse ja aitab teistel leida enda jaoks õiged tooted.
        </p>
    </div>
