...
class ProductController extends APIController
{
    ...
    /**
     * Return price range (min & max) for given filters (e.g. category_id).
     */
    public function priceRange(): \Illuminate\Http\JsonResponse
    {
        $params = request()->only(['category_id']);

        $min = $this->productRepository->getMinPrice($params);
        $max = $this->productRepository->getMaxPrice($params);
