    ...
    'account' => [
     ...
     'dashboard' => [
        'index' => [
            ...
            'average-sale'                => 'Keskmine tellimuse väärtus',
            'color'                       => 'Värv',
            'customer-info'               => 'Suurima ostusummaga klienti ei leitud',
            'customer-with-most-sales'    => 'Suurima ostusummaga klient',
            'date-duration'               => ':start - :end',
            'decreased'                   => ':progress%',
            'empty-threshold'             => 'Tühja laoseisu piir',
            'empty-threshold-description' => 'Ühtegi toodet pole saadaval',
            'end-date'                    => 'Lõppkuupäev',
            'from'                        => 'Alates',
            'increased'                   => ':progress%',
            'more-products'               => ':product_count+ rohkem pilte',
            'order'                       => ':total_orders tellimust',
            'order-count'                 => ':count tellimust',
            'order-id'                    => '#:id',
            'overall-details'             => 'Üldine ülevaade',
            'pay-by'                      => 'Makseviis – :method',
            'product-count'               => ':count toodet',
            'product-image'               => 'Toote pilt',
            'product-info'                => 'Lisa seotud tooteid kiiresti.',
            ...
            'stock-threshold'             => 'Laoseisu piirväärtus',
            'store-stats'                 => 'Poestatisitika',
            'title'                       => 'Töölaud',
            'to'                          => 'Kuni',
            'today-customers'             => 'Tänased kliendid',
            'today-details'               => 'Tänased andmed',
            'today-orders'                => 'Tänased tellimused',
            'today-sales'                 => 'Tänane müük',
            'top-performing-categories'   => 'Parimad kategooriad',
            'top-selling-products'        => 'Enim müüdud tooted',
            'total-customers'             => 'Kliente kokku',
            'total-orders'                => 'Tellimusi kokku',
            'total-sales'                 => 'Müüki kokku',
            'total-stock'                 => ':total_stock ühikut laos',
            'total-unpaid-invoices'       => 'Maksmata arvete kogusumma',
            'unique-visitors'             => ':count unikaalset',
            'user-info'                   => 'Kiire ülevaade, mis sinu poes toimub',
